! function t(e, r, n) {
  ...
  2: [function (t, e, r) {
    ...
    c = t("./utils"), s = c.detectIE() || 0 / 0, 9 > s ? t("json2") : (window.MutationObserver = t("mutation-observer"), a = t("tree-mirror")), u = t("./info"), c = t("./utils"), i = t("./messaging_observer"), o = t("./server_imp_setting"), d = c.detectIOS() || 0 / 0, n = function () {
      ...
      return s = null, N = 3, p = [], r = {}, f = {}, E = {
        ...
        if (o = [], d = !0, t.leaf) 1 === t.nodeType && ((null != (h = t.attributes) ? h.href : void 0) || null != t.text || null != t.obj) && (s = this.nodeMessage(t, !0), e > 1 && (s.idx = t.idx), o.push(s));
        else if (0 === t.childNodes.length && -1 === c.indexOf(S, t.tagName));
        else {
        ...
        if (n = {}, x = e.tagName, "IMG" === x ? (null != (S = e.src) ? S.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (n.h = e.src) : c.hasAttr(e, "href") && (i = e.getAttribute("href"), i && 0 !== i.indexOf("javascript") && (n.h = c.normalizePath(i.slice(0, 320)))), c.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0) n.v = e.getAttribute("data-growing-title");
          ...
          if (u.isLeaf(e))
            ...
            else if ("INPUT" === x && -1 !== c.indexOf(C, e.type)) n.v = c.processText(e.value);
        else if ("svg" === x)
          for (N = e.childNodes, o = 0, w = N.length; w > o; o++) r = N[o], 1 === r.nodeType && "use" === r.tagName && c.hasAttr(r, "xlink:href") && (n.v = r.getAttribute("xlink:href"));
        else E = "", null != e.textContent ? E = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (E = e.innerText.replace(/[\n \t]+/g, " ").trim()), E.length > 0 && (E.length < 50 ? n.v = c.processText(E) : "A" === x && (n.v = c.processText(E.slice(0, 50))));
          ...
          return n
        }() && (h = g))), null != h && (f = u.containerElemContent(h), (null != f ? f.length : void 0) > 0 && (n.obj = f + " (" + e.checked + ")"))) : "password" !== e.type && (c.hasAttr(e, "growing-track") || c.hasAttr(e, "data-growing-track")) && (n.v = c.processText(e.value)) : "SELECT" === x && (n.v = c.processText(e.value), 1 === e.selectedOptions.length && null != e.selectedOptions[0].label && (n.obj = e.selectedOptions[0].label)));
        else if ("submit" === t)
          for (O = e.getElementsByTagName("input"), p = 0, y = O.length; y > p; p++) d = O[p], ("search" === d.type || "text" === d.type && ("q" === d.id || -1 !== d.id.indexOf("search") || -1 !== d.className.indexOf("search") || "q" === d.name || -1 !== d.name.indexOf("search"))) && (n.x = u.path(d).xpath, n.v = c.processText(d.value.trim()));
        return n
        ...
        return c.bind(window, "message", function (t) {
          return function (e) {
            var r, n, i, o;
            try {
              if (r = e.data, r.ai !== window.vds.accountId) return;
              switch (i = r.mode || r.circleMode) {
  ...
  5: [function (t, e, r) {
    ...
    u = t("./guid"), a = t("cookie"), p = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, l = ["I", "SPAN", "EM", "svg"], d = p.detectIE() || 0 / 0, i = function () {
      ...
      path: function (t, e) {
        ...
        if (null == e && (e = !1), a = "", g = !1, n = {}, h = !1, c = !1, C = void 0, s = 0, y = [], o = [], t === document) return {
          isIgnore: !0
        };
        for (r = new i(t);
      ...
      onlyContainsChildren: function (t, e) {
        ...
        for (o = t.children, n = 0, i = o.length; i > n; n++)
          if (r = o[n], -1 === p.indexOf(e, r.tagName)) return !1;
        return !0
      },
  ...
  6: [function (t, e, r) {
    ...
    if (t("./shim"), i = t("./tracker"), n = t("./dom_observer"), b = t("./utils"), l = t("./guid"), u = [], c = new n, w = new i(c), a = function () {
        var t, e, r;
      ...
      for (null == window._vds && (window._vds = [
        ...
        ]), g = window._vds, f = 0, p = g.length; p > f; f++) s = g[f], "track" === (v = s[0]) ? u.push(s) : a.apply(null, s);
      window._vds = {
        push: function () {
        ...
        return a.bind(window, "message", function (t) {
          return function (e) {
            ...
            if (n = e.data, n.ai === window.vds.accountId && (c = n.mode || n.circleMode, t.isSdkEvent(c) && (!n.fsna || "sdk" === n.fsna))) {
              ...
              if (h = n.mode, u.call(o, h) >= 0) a.spreadToInnerIframes(n);
  ...
  8: [function (t, e, r) {
    var n, i, o, a, s, u, d, c, h, l = [].indexOf || function (t) {
        for (var e = 0, r = this.length; r > e; e++)
          if (e in this && this[e] === t) return e;
        return -1
      },
    ...
    u = t("lzstring"), h = t("./utils"), a = h.detectIE() || 0 / 0, d = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), o = d ? parseInt(d[2], 10) : !1, s = !1, o && 22 > o ? n = !1 : (n = !0, c = navigator.userAgent, l.call(window, "ArrayBufferView") >= 0 || (-1 !== c.indexOf("Android") ? n = !1 : -1 !== c.indexOf("CPU OS ") ? -1 !== c.indexOf("CPU OS 6_") ? n = !1 : -1 !== c.indexOf("CPU OS 5_") ? n = !1 : -1 !== c.indexOf("CPU OS 4_") ? n = !1 : -1 !== c.indexOf("CPU OS 3_") && (n = !1) : -1 !== c.indexOf("CPU iPhone OS ") ? -1 !== c.indexOf("iPhone OS 6_") ? n = !1 : -1 !== c.indexOf("iPhone OS 5_") ? n = !1 : -1 !== c.indexOf("iPhone OS 4_") && (n = !1) : -1 !== c.indexOf("Intel Mac OS X") && (-1 !== c.indexOf("Mac OS X 10_6") ? n = !1 : -1 !== c.indexOf("Mac OS X 10_7") && (n = !1)))), i = function () {
      function t(t, e, r) {
        this.user = t, this.urlMap = e, this.callback = r, this.imgSendClear = f(this.imgSendClear, this), this.send = f(this.send, this)
      }
      var e, r, i;
  ...
  11: [function (t, e, r) {
    ...
    n = t("./sender"), a = t("./utils"), o = t("./info"), i = function () {
      ...
      var e;
      return e = "0.7.10", t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
        imp: !0,
        hashtag: !1,
        touch: !1,
        bot: !0,
        ...
        return o = new n(this.user, this.getUrlMap(), t), o.connect({
          isBot: !!r
        })
      }, t
    }(), e.exports = i
            ...
            for (o = 0; o < t.length; o += 1)
              if (u = t.charAt(o), Object.prototype.hasOwnProperty.call(a, u) || (a[u] = l++, s[u] = !0), d = c + u, Object.prototype.hasOwnProperty.call(a, d)) c = d;
                ...
                if (Object.prototype.hasOwnProperty.call(s, c)) {
                  ...
                  for (i = a[c], n = 0; f > n; n++) g = g << 1 | 1 & i, v == e - 1 ? (v = 0, p.push(r(g)), g = 0) : v++, i >>= 1;
          ...
          if (void 0 === e) {
            ...
            for (var c = t.parentElement; c && "BODY" !== c.tagName && "HTML" !== c.tagName;) {
              ...
              if (l && null === l.match(/^[0-9]/) && (h += "#" + l), c.hasAttribute("class"))
                for (var f = c.getAttribute("class").trim().split(/\s+/).sort(), p = 0; p < f.length; p++) f[p].length > 0 && null === o.exec(f[p]) && (h += "." + f[p]);
          ...
          switch (1 === g.nodeType && -1 !== u.indexOf(t.tagName) && (g.dom = t), g.nodeType) {
            ...
            case 1:
              ...
              if (y)
                ...
                if (0 === _.length && "I" !== w.tagName && "A" !== w.tagName) return null;
                g.text = _
